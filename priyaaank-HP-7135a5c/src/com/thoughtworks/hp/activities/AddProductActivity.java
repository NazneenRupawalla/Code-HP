...
public class AddProductActivity extends Activity implements TextWatcher {
	...
	protected int REQUEST_IMAGE=100;

	private ImageProcessor imageCapturer;
    ...
    private void bindImageCapturer() {
  			imageCapturer =new ImageProcessor(this, (ImageView) this.findViewById(R.id.capture_button));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        {
        	try {
        		List<Product> productfromImageCapturer=imageCapturer.processImage();
        		Product product=productfromImageCapturer.get(0);
        		if(product!=null)
        		{
