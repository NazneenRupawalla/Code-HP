...
//TODO disabling the button when the product is not yet identified or the list is empty.
	...
	private void bindPaymentView() {

		paymentButton.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent paymentOptions=new Intent(AddProductActivity.this,DeliveryOptions.class);
				startActivityForResult(paymentOptions,PAYMENT_CODE);
	...
	private void refreshProductRelatedUIElements() {
        ...
        editor.putString(ServiceConstants.TOTAL_AMOUNT, totalCost);
        editor.commit();
